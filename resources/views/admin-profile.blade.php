    ...
    <div class="chart-container">
        <div class="chart-wrapper">
            <div class="post-statistics">
                ...
                <ul>
                    <li>Tổng số bài đăng: <span>{{ $totalPost }}</span></li>
                    <li>Số bài đã duyệt: <span>{{ $totalPostApprovedTrue }}</span></li>
                    <li>Số bài chưa duyệt: <span>{{ $totalPostApprovedFalse }}</span></li>
                </ul>
            ...
            <div class="comment-statistics">
                ...
                <ul>
                    <li>Tổng số bình luận: <span>{{ $totalComment }}</span></li>
                </ul>
                <canvas id="commentChart"></canvas>
            </div>

            <div class="user-statistics" style="height: 400px;">
                <h3 style="color: black">Thống Kê Người Dùng</h3>
                <ul style="">
                    <li>Tổng số người dùng: <span>{{ $totalUser }}</span></li>
                </ul>
...
<script>
    ...
    var postChart = new Chart(postChartCtx, {
        type: 'bar',
        data: {
            labels: ['Tổng số', 'Đã duyệt', 'Chưa duyệt'],
            datasets: [{
                label: 'Bài đăng',
                data: [{{ $totalPost }}, {{ $totalPostApprovedTrue }}, {{ $totalPostApprovedFalse }}],
    ...
    var commentChartCtx = document.getElementById('commentChart').getContext('2d');
    var commentChart = new Chart(commentChartCtx, {
        type: 'doughnut',
        data: {
            labels: ['Tổng số bình luận'],
            datasets: [{
                data: [{{ $totalComment }}],
