...
Route::middleware([\App\Http\Middleware\CheckRole::class . ':1'])->group(function () {
    ...
    Route::get('/user/profile/updatePost/{id}',[UserController::class,'showUpdatePostForm'])->name('user.updatePostForm');
    Route::post('/user/profile/updatePost/{id}',[UserController::class,'updatePost'])->name('user.updatePost');
    Route::delete('/user/profile/deletePost/{id}', [UserController::class, 'deletePost'])->name('user.deletePost');
...
Route::middleware([\App\Http\Middleware\CheckRole::class . ':2'])->group(function () {
    ...
    Route::delete('/admin/post-management/deletePost/{id}', [AdminController::class,'deletePost'])->name('admin.deletePost');
    Route::post('/admin/post-management/{id}', [AdminController::class,'updateStatusPost'])->name('admin.updateStatus');
